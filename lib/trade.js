...
const debug = require('debug')('TradeCalendar');
...
TradeCalendar.prototype.logArgsRealStamp = debug.enabled ? function (args) {
...
TradeCalendar.prototype.logArgsStamp = debug.enabled ? function (args) {
  return _.reduce(args, (r, v, k) => {
    if (v.valueOf) {
...
TradeCalendar.prototype.logRealStamp = debug.enabled ? function (stamp) {
  return moment(stamp).format();
} : ()=> {
};

TradeCalendar.prototype.logStamp = debug.enabled ? function (stamp) {
