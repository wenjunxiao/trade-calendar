...
TradeCalendar.prototype.setTimeout = function (code, delay) {
  return this.realTimeoutAt(code, Date.now() + delay);
};

TradeCalendar.prototype.setTimeoutAt = function (code, timestamp) {
  return this.setTimeout(code, timestamp - this.now());
};
